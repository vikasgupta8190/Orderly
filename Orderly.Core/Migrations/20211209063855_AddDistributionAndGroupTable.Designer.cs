...
namespace Orderly.Core.Migrations
{
    ...
    [Migration("20211209063855_AddDistributionAndGroupTable")]
    partial class AddDistributionAndGroupTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orderly.Core.Domain.Distribution.DistributionAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DistributionAddress");
                });

            modelBuilder.Entity("Orderly.Core.Domain.Distribution.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Orderly.Core.Domain.Distribution.DistributionAddress", b =>
                {
                    b.HasOne("Orderly.Core.Domain.Distribution.Group", "Group")
                        .WithMany("distributionAddress")
                        .HasForeignKey("GroupId");
            ...
            modelBuilder.Entity("Orderly.Core.Domain.Distribution.Group", b =>
                {
                    b.Navigation("distributionAddress");
                });
