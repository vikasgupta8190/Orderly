...
namespace Orderly.Core.Migrations
{
    ...
    [Migration("20211229101017_AddMonitoringTable")]
    partial class AddMonitoringTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orderly.Core.Domain.Contact.Monitoring", b =>
                {
                    ...
                    b.HasIndex("NetworkTokenId")
                        .IsUnique()
                        .HasFilter("[NetworkTokenId] IS NOT NULL");
            ...
            modelBuilder.Entity("Orderly.Core.Domain.Contact.Monitoring", b =>
                {
                    b.HasOne("Orderly.Core.Domain.Tokens.NetworkToken", "NetworkToken")
                        .WithOne("Monitoring")
                        .HasForeignKey("Orderly.Core.Domain.Contact.Monitoring", "NetworkTokenId");
