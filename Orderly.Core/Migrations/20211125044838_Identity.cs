        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonitoringTypeId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortfolioMonitorings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PortfolioMonitorings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PortfolioMonitorings_MonitoringTypes_MonitoringTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvestmentTransactionLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VestingLockup = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    VestingTokenPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    VestingId = table.Column<int>(type: "int", nullable: false),
                    DistributionTypeId = table.Column<int>(type: "int", nullable: false),
                    InvestmentTypeId = table.Column<int>(type: "int", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SaftFile = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PortfolioMonitorings_MonitoringTypeId",
                table: "PortfolioMonitorings",
                column: "MonitoringTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioMonitorings_UserId",
                table: "PortfolioMonitorings",
                column: "UserId");
