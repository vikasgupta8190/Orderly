...
namespace Orderly.Core.Migrations
{
    ...
    [Migration("20211222072435_MakeNullableColumnsInvestmentTokenTable")]
    partial class MakeNullableColumnsInvestmentTokenTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orderly.Core.Domain.Investment.InvestmentToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Orderly.Core.Domain.Investment.InvestmentToken", b =>
                {
                    b.HasOne("Orderly.Core.Domain.Investment.UserInvestment", "userInvestments")
                        .WithMany("investmentTokens")
                        .HasForeignKey("InvestmentId");
